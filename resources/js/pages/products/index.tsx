        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <section className="mx-auto w-full max-w-7xl px-4 py-10">
                <div className="mb-8 rounded-2xl bg-gradient-to-r from-pink-100 via-rose-50 to-violet-100 p-6 shadow-sm dark:from-pink-900/30 dark:via-rose-900/30 dark:to-violet-900/30">
                    ...
                    <p className="mt-2 text-sm text-zinc-600 md:text-base dark:text-zinc-300">
                        Produk handmade & kreatif: undangan nikah, flash card, mahkota, stiker, kipas, dan lainnya.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {filtered.map((p) => (
                        <Card
                            key={p.id}
                            className="group overflow-hidden rounded-2xl border-0 bg-white shadow-sm ring-1 ring-rose-100 transition hover:-translate-y-1 hover:shadow-md dark:bg-zinc-900 dark:ring-rose-900/30"
                        >
